...
PATH_WRITE = '/Users/cylopez/Documents/projects/license-plate-recognition/plates_mania_lp/test'
...
def verifySize(height_img, contour):
    ...
    if charAspect > minAspect and charAspect < maxAspect and h/height_img > char_to_img_aspect:
        ...
        box = np.int0(box)
        cv2.drawContours(th,[box],0,(255,255,255),2)
        plt.imshow(th), plt.title("Min Rect Contours")
        plt.show()
        return True
    else:
        return False
